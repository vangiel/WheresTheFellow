...
plt.subplot(311)
plt.plot(xx, x_gt, 'g-', label='x (ground truth)')
plt.plot(xx, x_cc, 'r-', label='x (analytical estimation)', linestyle=(0, (1, 1)))
plt.plot(xx, x_nn, 'b-', label='x (GNN)', linestyle='dashed')
plt.legend(prop={'size': 11})

plt.subplot(312)
plt.plot(xx, z_gt, 'g-', label='y (ground truth)')
plt.plot(xx, z_cc, 'r-', label='y (analytical estimation)', linestyle=(0, (1, 1)))
plt.plot(xx, z_nn, 'b-', label='y (GNN)', linestyle='dashed')
plt.legend(prop={'size': 11})


plt.subplot(313)
plt.plot(xx, xxx_degrees(a_gt), 'g-', label='angle (ground truth)')
plt.plot(xx, xxx_degrees(a_cc), 'r-', label='angle (analytical estimation)', linestyle=(0, (1, 1)))
plt.plot(xx, xxx_degrees(a_nn), 'b-', label='angle (GNN)', linestyle='dashed')
